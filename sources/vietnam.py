...
REGION = {
    "sources": [
        {"fetch": fetch_itviec_jobs, "name": "ITviec", "color": "#e53935"},
        {"fetch": fetch_topdev_jobs, "name": "TopDev", "color": "#1565c0"},
        {"fetch": fetch_vietnamdevs_jobs, "name": "VietnamDevs", "color": "#6a1b9a"},
